...
void ungarrison(buttonparam b)
{
	...
	map[(int)allunits[b.player][allbuildings[b.player][selectedunits[b.player][0]].garrisoned[b.index-indexGarrisonbutton]]->y][(int)allunits[b.player][allbuildings[b.player][selectedunits[b.player][0]].garrisoned[b.index-indexGarrisonbutton]]->x].unitplayer=b.player;//(int)allbuildings[b.player][selectedunits[b.player][0]].y+((int)(b.index-indexGarrisonbutton)/allbuildings[b.player][selectedunits[b.player][0]].width)*2+(int)allbuildings[b.player][selectedunits[b.player][0]].height+1][(int)allbuildings[b.player][selectedunits[b.player][0]].x+(b.index-indexGarrisonbutton*2)].player=b.player;
